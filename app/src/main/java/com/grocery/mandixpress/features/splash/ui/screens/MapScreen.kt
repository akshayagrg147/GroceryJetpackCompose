...
fun MapScreen(
    ...
    MainScreen(mFusedLocationClient,true,context,sharedPreferences,navController)
...
fun MainScreen(
    ...
    GroceryAppTheme(useSystemUIController ) {
        MapScreen1(fusedLocationProviderClient,context,sharedPreferences,navController)
    }
