...
@HiltViewModel
class CartItemsViewModal @Inject constructor(val sharedpreferenceCommon: CombinedSharedPreference,
                                             val dao: Dao,
    ...
    private fun updateDeliveryRate() {
            ...
            viewModelScope.launch {
                ...
                if(cartItems.isEmpty()) {
                    sharedpreferenceCommon.setMinimumDeliveryAmount(0.00f)
...
//                    sharedpreferenceCommon.setMinimumDeliveryAmount(sellerPickMinDelivery.price?:"")
                    ...
                    sharedpreferenceCommon.setDeliverySellersCharges((decimalRupees.toFloat()*5))
